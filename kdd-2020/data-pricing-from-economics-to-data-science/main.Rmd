...
- The complexity of computing prices as to be polynomial with respect to the number of sellers $\theta(2^{sellers})$, and cannot grow concerning the number of goods/buyers when prices are updated
