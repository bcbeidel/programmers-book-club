...
Rather than outputing a bounding box; we can instead output the coordiantes of important points.  i.e., provide string of points outlinining the points on a face.
...
- start with a small region, increase size small region and increase size w/ iteration

This is computationally intensive, however, it can be implemented with convoltions, adding complexity, but leveraging the shared computations.
