...
Consider a player who got exactly 100 hits in the first 300 at bats.  So, let's simulate some batting statistics for the first 300 at bats.  Starting with our prior belief regarding the distribution of batting averages we start with Beta(81, 219)
...
simulations %>% 
            ...
            ggplot2::ggplot(aes(x=true_average)) + 
                     geom_bar(stat="bin", aes(y=..density.., line="grey")) + 
